...
1. For each feature mentioned, create a worktree at `../<current-repo-name>-[feature-name]` with branch `feature/[feature-name]` (derive the base prefix from the current repository folder name, not a hard-coded path)
